...
{% include tip.html content="1. Do you want to access research-ready hardware out of the box? Do you want to skip the unfamiliar hardware selection, installation, and tricky setup? 
...
{% include tip.html content="The PicoScenes software installer installs the UHD software. So, you skip the UHD installation or source code building steps." %}
...
1. **Download and install the PicoScenes Source Updater:**
   ...
   {% include note.html content="The PicoScenes Source Updater registers the PicoScenes software repository to your system, enabling you to install and automatically upgrade PicoScenes using the apt command." %}
...
3. **Install the PicoScenes software**
   ...
   {% include tip.html content="If you accidentally choose ‘<No>’, the installer will provide instructions on how to restart the installation process." %}
