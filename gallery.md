...
- [PicoScenes Driving USRP B210 and HackRF One to Inject 11AX Packets and Measuring CSI](#b210_hackrf)
...
PicoScenes supports the most cost-efficient SDR devices, HackRF One. With this only 200$ SDR, Wi-Fi sensing researchers can perform 802.11a/g/n/ac/ax packet injection, receive standard 20-MHz bandwidth packet in realtime, and access the comple PHY-layer information. For more information, please visit [PicoScenes now officially supports HackRF One](https://zpj.io/picoscenes-supports-hackrf/).
...
For more details, you may refer to [picoscenes_paper](picoscenes_paper).

![Continuous CSI measurements](/images/scan_cf_figure/cf_scan.jpg)
*Continuous and overlapped CSI measurements over a large spectrum can be obtained via PicoScenes on QCA9300.*

> **Hint:** Why do the CSI measurements misalign with each other? Do you wanna stitch them together? You may refer to [picoscenes_paper](picoscenes_paper).

<a id="qca9300_tune_bw"></a>
...
To fully demonstrate the capacity of multi-NIC CSI measurement, we setup a 27-NIC Wi-Fi sensing array. The array contains 27 QCA9300 NICs and 10 1-to-3 PCI-E bridge adapters. For more details, you may refer to the evaluation part of [picoscenes_paper](picoscenes_paper).

![27-NIC Array](/images/NICArrayLayout-horizontal.jpg)
